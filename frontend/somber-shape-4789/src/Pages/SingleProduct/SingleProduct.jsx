...
import { Accordion, AccordionButton, AccordionIcon, AccordionItem, AccordionPanel, Box, Heading, Image, ListItem, Radio, RadioGroup, Spinner, Text, UnorderedList, useDisclosure, useToast } from '@chakra-ui/react'
                ...
                <Box id={styles.topDiv}>
                    ...
                    <Box id={styles.rightDiv}>
                        ...
                        <Box id={styles.addToCartDiv} >
                            ...
                            <Text id={styles.addToCartButton} onClick={() => {
                                dispatch(addproductrequest(product._id))
                                toast({
