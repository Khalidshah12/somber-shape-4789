...
export default function Pickup({ isOpen, onOpen, onClose, setValue }) {
    ...
    return (
        <>
            ...
            <Text onClick={onOpen} cursor='pointer' fontSize='xs' pt='5px' textDecoration='underline' color='#333333'>Set Store</Text>
                ...
                <ModalContent>
                    ...
                    <ModalFooter pb='20px'>
                        <FormControl>
                            ...
                            <InputGroup>
                                <Input borderRadius='' value={input} onChange={(e) => {
                            ...
                            {isHelperText
                                ? input === '' ? <FormHelperText fontSize='12px' color='crimson'>Please enter a ZIP code</FormHelperText> : <FormHelperText fontSize='12px' color='crimson'>Sorry! There are no participating stores near that location.Please try another ZIP code.</FormHelperText>
                                : ""
                            }
                        </FormControl>
                    </ModalFooter>
